...
if (( "$GIT_STATUS" > 0 )); then
  ...
  CURRENT_NUMBER_OF_COMMITS=`git log --oneline | wc -l`
	...
	PACKAGES=('AWSSDK.Core' 'AWSSDK.S3' 'AWSSDK.SQS' 'Pomelo.EntityFrameworkCore.MySql' 'DocumentFormat.OpenXml' 'Microsoft.EntityFrameworkCore' 'Microsoft.EntityFrameworkCore.Design' 'Microsoft.EntityFrameworkCore.Relational')
