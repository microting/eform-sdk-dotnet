...
namespace eFormSDK.Integration.Tests
{
    ...
    public class CoreTestCaseReadAllLong : DbTestFixture
    {
        ...
        public async Task Core_Case_CaseReadAll_Long()
        {
            ...
            workers worker1 = testHelpers.CreateWorker("aa@tak1.dk", "Arne1", "Jensen", testHelpers.GetRandomInt());
            workers worker2 = testHelpers.CreateWorker("aa@tak2.dk", "Arne2", "Jensen", testHelpers.GetRandomInt());
            workers worker3 = testHelpers.CreateWorker("aa@tak3.dk", "Arne3", "Jensen", testHelpers.GetRandomInt());
            workers worker4 = testHelpers.CreateWorker("aa@tak4.dk", "Arne4", "Jensen", testHelpers.GetRandomInt());

            #endregion

            #region site
            sites site1 = testHelpers.CreateSite("SiteName1", testHelpers.GetRandomInt());
            sites site2 = testHelpers.CreateSite("SiteName2", testHelpers.GetRandomInt());
            sites site3 = testHelpers.CreateSite("SiteName3", testHelpers.GetRandomInt());
            sites site4 = testHelpers.CreateSite("SiteName4", testHelpers.GetRandomInt());

            #endregion

            #region units
            units unit1 = testHelpers.CreateUnit(testHelpers.GetRandomInt(), 49, site1, 348);
            units unit2 = testHelpers.CreateUnit(testHelpers.GetRandomInt(), 49, site2, 348);
            units unit3 = testHelpers.CreateUnit(testHelpers.GetRandomInt(), 49, site3, 348);
            units unit4 = testHelpers.CreateUnit(testHelpers.GetRandomInt(), 49, site4, 348);
