...
LOCK TABLES `CheckListSiteVersions` WRITE;
...
LOCK TABLES `CheckListSites` WRITE;
...
LOCK TABLES `CheckListTranslationVersions` WRITE;
...
LOCK TABLES `CheckListTranslations` WRITE;
...
LOCK TABLES `CheckListValueVersions` WRITE;
...
LOCK TABLES `CheckListValues` WRITE;
...
LOCK TABLES `CheckListVersions` WRITE;
...
LOCK TABLES `EntityGroupVersions` WRITE;
...
LOCK TABLES `EntityGroups` WRITE;
...
LOCK TABLES `EntityItemVersions` WRITE;
...
LOCK TABLES `FieldOptionTranslationVersions` WRITE;
...
LOCK TABLES `FieldOptionTranslations` WRITE;
...
LOCK TABLES `FieldOptionVersions` WRITE;
...
LOCK TABLES `FieldTranslationVersions` WRITE;
...
LOCK TABLES `FieldTranslations` WRITE;
...
LOCK TABLES `FieldValueVersions` WRITE;
...
LOCK TABLES `FieldVersions` WRITE;
...
INSERT INTO `Languages` VALUES (1,1,'created','2021-11-30 19:13:01.303334','2021-11-30 19:13:01.303378','Danish','da'),(2,1,'created','2021-11-30 19:13:01.416989','2021-11-30 19:13:01.416989','English','en-US'),(3,1,'created','2021-11-30 19:13:01.462160','2021-11-30 19:13:01.462161','German','de-DE');
...
LOCK TABLES `NotificationVersions` WRITE;
