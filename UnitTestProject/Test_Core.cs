...
namespace UnitTestProject
{
    ...
    public class Test_Core
    {
        ...
        {
            return "Data Source=DESKTOP-7V1APE5\\SQLEXPRESS;Initial Catalog=Microting;Integrated Security=True";            //Database Standard
            //return "Data Source=DESKTOP-7V1APE5\\SQLEXPRESS;Initial Catalog=MicrotingTest;Integrated Security=True";        //Database Test
        }
        ...
        public void T003_Basic_XmlConverter()
        {
            lock (_testLock)
            {
                ...
                checkValueB = LoadFil("xml.txt");
                MainElement main = core.TemplatFromXml(checkValueB);
        ...
        public void T021_Request_ClassToXml()
        {
            lock (_testLock)
            {
                ...
                e2.DataItemList.Add(new CheckBox("5", false, false, "Check box", "this is a description", "e2f4fb", 5, true, true));
                ...
                e3.DataItemList.Add(new CheckBox("1", true, false, "You are sure?", "Verify please", "e2f4fb", 1, false, false));
                #endregion
        ...
        private void Setup()
        {
            lock (_setupLock)
            {
                ...
                serverConnectionString = WhichServer();
