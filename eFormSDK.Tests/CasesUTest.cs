    ...
    public class CasesUTest : DbTestFixture
    {
        ...
        public void Cases_Create_DoesCreate()
        {
            ...
            //Assert
             ...
             Assert.AreEqual(theCase.SiteId, cases[0].SiteId);
             Assert.AreEqual(theCase.Status, cases[0].Status);
             Assert.AreEqual(theCase.Type, cases[0].Type);
             Assert.AreEqual(theCase.UnitId, cases[0].UnitId);
             Assert.AreEqual(theCase.WorkerId, cases[0].WorkerId);
             Assert.AreEqual(theCase.CaseUid, cases[0].CaseUid);
             Assert.AreEqual(theCase.CheckListId, cases[0].CheckListId);
             ...
             Assert.AreEqual(theCase.UnitId, caseVersions[0].UnitId);
             Assert.AreEqual(theCase.WorkerId, caseVersions[0].WorkerId);
             Assert.AreEqual(theCase.CaseUid, caseVersions[0].CaseUid);
             Assert.AreEqual(theCase.CheckListId, caseVersions[0].CheckListId);
        ...
        public void Cases_Update_DoesUpdate()
        {
            ...
            Assert.AreEqual(theCase.SiteId, caseVersions[1].SiteId);
            Assert.AreEqual(theCase.Status, caseVersions[1].Status);
            Assert.AreEqual(theCase.Type, caseVersions[1].Type);
            Assert.AreEqual(theCase.UnitId, caseVersions[1].UnitId);
            Assert.AreEqual(theCase.WorkerId, caseVersions[1].WorkerId);
            Assert.AreEqual(theCase.CaseUid, caseVersions[1].CaseUid);
            Assert.AreEqual(theCase.CheckListId, caseVersions[1].CheckListId);
